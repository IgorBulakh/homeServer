(() => {
    ...
    function initSliders() {
        if (document.querySelector(".rewievs__slider")) new swiper_core_Swiper(".rewievs__slider", {
            ...
            navigation: {
                prevEl: ".rewievs__button--prev",
                nextEl: ".rewievs__button--next"
            },
            on: {}
        });
    }
